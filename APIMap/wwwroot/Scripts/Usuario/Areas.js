class Areas {
    ...
    createElementoHTML(ubicacion) {
        ...
        elemento.setAttribute('data-id', ubicacion.id);
        ...
        elemento.addEventListener('click', () => {
            this.guardarIdYRedirigir(ubicacion.id);
        });
